...
\end{equation}
gdzie: $d_L = 2 d_c$ to odległość końca belki od osi obrotu, $d_k$ to długość korby. Zależność \eqref{eq:uproszczona_zaleznosc_kata_belki} wynika z~założenia, że punkty zaczepu korbowodu przebędą taką samą drogę łukową, a zatem $\theta d_k = \alpha d_L$.
