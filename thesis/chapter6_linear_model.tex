...
\begin{itemize}
    ...
    \item $G_b(s)$ jest transmitancją (typu \textit{SIMO}) zlinearyzowanego systemu wyodrębnionego z równań stanu~\eqref{eq:rownania_stanu}, \eqref{eq:rownania_wyjscia},
...
System $G_b(s)$, wyodrębniony z równań stanu dla całego modelu, przedstawia się jako  następujący układ równań stanu:
\begin{align}
    \begin{bmatrix}
        \dot{x}_3 \\ \dot{x}_4
    \end{bmatrix}
