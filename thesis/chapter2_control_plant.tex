...
\begin{figure}[H]
    ...
    \includesvg[width=0.6\textwidth,svgpath=./vector_graphics/]{kulka_belka_schemat_uproszczony}
...
\begin{figure}[H]
	\centering
    % TODO: przerobić rysunek w Inkscape
	% \includesvg[width=0.5\textwidth,svgpath=./vector_graphics/]{schemat_korba}
...
\begin{figure}[H]
	\centering
    % TODO: przerobić rysunek w Inkscape
	% \includesvg[width=0.2\textwidth,svgpath=./vector_graphics/]{beam_xsection}
...
\begin{figure}[H]
    \centering
    % TODO: przerobić rysunek w Inkscape
    \includesvg[width=0.4\textwidth,svgpath=./vector_graphics/]{sensor_bracket}
